...
st.write("""
But what if there's a question the provided stats didn't quite answer? Or perhaps you can't be bothered to sieve through the barrage of data. Enter our Squash Bot—a conversational maestro ready to fetch the answers. Whether it's an insight from last week's match or a curiosity about your overall performance against left-handed players, the bot's got your back. After all, it's 2023 and sifting through stats manually is so last decade.
""")
